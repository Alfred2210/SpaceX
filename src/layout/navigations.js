...
const Navigation = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (page === '/') {
      footerColor = 'white';
      body.style.backgroundImage = `url("https://sxcontent9668.azureedge.us/cms-assets/assets/Starlink_6_5_SLC_40_2023_07_09_DSC_9579_Desktop_133863aee0.jpg")`;
    } else {
      footerColor = 'black';
    }
  ...
  return (
    <>
          ...
          <div class="px-4 sm:px-6 lg:px-8">
            <nav class="relative flex items-center justify-between h-16 lg:h-20">
              <div class="hidden lg:flex lg:items-center lg:space-x-10">
                ...
                <Link to="/space-x-lastest-launch">
                  <a title="" class="text-base font-medium text-black">
                    Lastest Launch
                  </a>
                </Link>
                <Link to="/space-x-launches-history">
                  <a title="" class="text-base font-medium text-black">
                    Launches
                  </a>
                </Link>

                <Link to="/space-x-rockets">
                  <a title="" class="text-base font-medium text-black">
                    Rockets
                  </a>
                </Link>

                <Link to="/space-x-quiz">
                  <a title="" class="text-base font-medium text-black">
                    Quiz
                  </a>
                </Link>
      ...
      <section class="bg-transparent">
        <div class="max-w-screen-xl px-2 py-3 mx-auto space-y-2 overflow-hidden sm:px-6 lg:px-8">
          <div class="flex justify-center mt-8 space-x-6">
            <a
              href="https://www.facebook.com/spacextechnologies/"
              class={`text-${footerColor} hover:text-gray-500`}
            >
            ...
            <a
              href="https://github.com/r-spacex"
              class={`text-${footerColor} hover:text-gray-500`}
            >
          ...
          <p class={`mt-8 text-base leading-6 text-center text-${footerColor}`}>
